# PowerShell script to create DirectAdmin-compatible ZIP file with fonts
Write-Host "Creating DirectAdmin deployment package with fonts..." -ForegroundColor Green

# Define the project name and output file
$projectName = "halovpbank2025"
$outputFile = "$projectName-with-fonts.zip"
...
# Files and folders to include (with fonts)
$includeItems = @(
    "admin",
    "api",
    "assets/css",
...
Write-Host "Including files and folders with fonts:" -ForegroundColor Cyan
...
Write-Host "`nCreating ZIP file with fonts..." -ForegroundColor Yellow
...
Write-Host "`nDeployment package with fonts created successfully!" -ForegroundColor Green
Write-Host "File: $outputFile" -ForegroundColor White
Write-Host "Size: $fileSizeMB MB" -ForegroundColor White
Write-Host "`nReady for DirectAdmin upload!" -ForegroundColor Green

Write-Host "`nThis version includes:" -ForegroundColor Yellow
Write-Host "- All core PHP files" -ForegroundColor White
Write-Host "- Essential CSS/JS" -ForegroundColor White
Write-Host "- All required images" -ForegroundColor White
Write-Host "- Gilroy fonts (Bold, Regular, SemiBold)" -ForegroundColor White
Write-Host "- Database setup file" -ForegroundColor White
Write-Host "`nExcludes only PSD design files and documentation." -ForegroundColor Cyan

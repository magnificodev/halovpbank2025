...
<head>
    ...
    <style>
        ...
        .login{width:360px;background:var(--surface);border:1px solid var(--border);border-radius:12px;padding:24px 24px 20px;box-shadow:0 1px 8px rgba(17,24,39,.06)}
        ...
        input{width:100%;padding:11px 12px;border:1px solid var(--border);border-radius:10px;background:#fff;color:var(--text);font-size:14px}
        input:focus{outline:none;border-color:var(--accent-600);box-shadow:0 0 0 3px rgba(16,185,129,.15)}
        button{width:100%;padding:12px 14px;border:1px solid var(--accent);border-radius:10px;background:var(--accent);color:#fff;font-weight:700;cursor:pointer;transition:background .2s}
        button:hover{background:var(--accent-600)}
        /* Dark mode */
        body.dark{background:#0f172a;color:#e5e7eb}
        body.dark .login{background:#0b1220;border-color:#1f2937;box-shadow:0 1px 8px rgba(2,6,23,.4)}
        body.dark .brand,body.dark label,body.dark .hint{color:#94a3b8}
        body.dark h2{color:#e5e7eb}
        body.dark input{background:#111827;border-color:#1f2937;color:#e5e7eb}
        body.dark input::placeholder{color:#94a3b8}
        body.dark button{background:#059669;border-color:#059669}

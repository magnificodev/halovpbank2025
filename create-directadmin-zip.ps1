# PowerShell script to create DirectAdmin-compatible ZIP file
...
Write-Host "`nCreating ZIP file with Unix-style paths..." -ForegroundColor Yellow

# Create ZIP using .NET compression (ensures Unix paths)
